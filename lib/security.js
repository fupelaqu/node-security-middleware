 ...
 */
/**
 * Constructs a SimpleAccount instance for the specified realm with the given principals and credentials, with
 * the assigned roles and permissions.
 *
 * @param principals the identifying attributes of the account.
...
var Subject = function(realm, req, secure){
    ...
    if(utils.isUndefined(account)){
        ...
        if(utils.isDefined(account) && utils.isEqual(realm.name, account.realmName)){
            this.account = new SimpleAccount(account.principal, null, realm.realmName);
            console.log(
    ...
    else if(utils.isEqual(realm.realm, account.realmName)){
